...
const HeavySnowShowersAndThunderDay = ({ title, size, ...rest }: IconProps) => {
  const sun = useId()
  const cloud = useId()
  ...
  return (
    <IconWrapper title={title} size={size} {...rest}>
      ...
      <use xlinkHref={`#${s29d}`} x="0" y="0" width="100" height="100"></use>
    </IconWrapper>
  )
}

export default HeavySnowShowersAndThunderDay
