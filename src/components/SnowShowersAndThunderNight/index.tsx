...
const SnowShowersAndThunderNight = ({ title, size, ...rest }: IconProps) => {
  const cloud = useId()
  ...
  return (
    <IconWrapper title={title} size={size} {...rest}>
      ...
      <symbol id={s21n}>
        ...
        <use xlinkHref={`#${s14}`} x="0" y="0" width="100" height="100"></use>
      </symbol>
      <use xlinkHref={`#${s21n}`} x="0" y="0" width="100" height="100"></use>
    </IconWrapper>
  )
}

export default SnowShowersAndThunderNight
