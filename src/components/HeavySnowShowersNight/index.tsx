...
const HeavySnowShowersNight = ({ title, size, ...rest }: IconProps) => {
  const cloud = useId()
  ...
  return (
    <IconWrapper title={title} size={size} {...rest}>
      ...
      <symbol id={s45n}>
        ...
        <use xlinkHref={`#${s50}`} x="0" y="0" width="100" height="100"></use>
      </symbol>
      <use xlinkHref={`#${s45n}`} x="0" y="0" width="100" height="100"></use>
    </IconWrapper>
  )
}

export default HeavySnowShowersNight
