...
const HeavySleetShowersNight = ({ title, size, ...rest }: IconProps) => {
  const cloud = useId()
  ...
  return (
    <IconWrapper title={title} size={size} {...rest}>
      ...
      <symbol id={s43n}>
        ...
        <use xlinkHref={`#${s48}`} x="0" y="0" width="100" height="100"></use>
      </symbol>
      <use xlinkHref={`#${s43n}`} x="0" y="0" width="100" height="100"></use>
    </IconWrapper>
  )
}

export default HeavySleetShowersNight
