...
const HeavySnowShowersAndThunderPolarTwilight = ({
  title,
  size,
  ...rest
}: IconProps) => {
  ...
  return (
    <IconWrapper title={title} size={size} {...rest}>
      ...
      <use xlinkHref={`#${s29m}`} x="0" y="0" width="100" height="100"></use>
    </IconWrapper>
  )
}

export default HeavySnowShowersAndThunderPolarTwilight
