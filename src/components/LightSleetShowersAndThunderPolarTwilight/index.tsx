...
const LightSleetShowersAndThunderPolarTwilight = ({
  title,
  size,
  ...rest
}: IconProps) => {
  ...
  return (
    <IconWrapper title={title} size={size} {...rest}>
      ...
      <symbol id={s26m}>
        ...
        <use xlinkHref={`#${s31}`} x="0" y="0" width="100" height="100"></use>
      </symbol>
      <use xlinkHref={`#${s26m}`} x="0" y="0" width="100" height="100"></use>
    </IconWrapper>
  )
}

export default LightSleetShowersAndThunderPolarTwilight
