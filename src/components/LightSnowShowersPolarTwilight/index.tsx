...
const LightSnowShowersPolarTwilight = ({ title, size, ...rest }: IconProps) => {
  const sun = useId()
  const cloud = useId()
  ...
  return (
    <IconWrapper title={title} size={size} {...rest}>
      ...
      <symbol id={s44m}>
        ...
        <use xlinkHref={`#${s49}`} x="0" y="0" width="100" height="100"></use>
      </symbol>
      <use xlinkHref={`#${s44m}`} x="0" y="0" width="100" height="100"></use>
    </IconWrapper>
  )
}

export default LightSnowShowersPolarTwilight
