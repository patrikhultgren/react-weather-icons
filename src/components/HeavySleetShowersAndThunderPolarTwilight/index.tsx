...
const HeavySleetShowersAndThunderPolarTwilight = ({
  title,
  size,
  ...rest
}: IconProps) => {
  ...
  return (
    <IconWrapper title={title} size={size} {...rest}>
      ...
      <symbol id={s27m}>
        ...
        <use xlinkHref={`#${s32}`} x="0" y="0" width="100" height="100"></use>
      </symbol>
      <use xlinkHref={`#${s27m}`} x="0" y="0" width="100" height="100"></use>
    </IconWrapper>
  )
}

export default HeavySleetShowersAndThunderPolarTwilight
