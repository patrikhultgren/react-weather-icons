...
const LightRainShowersAndThunderDay = ({ title, size, ...rest }: IconProps) => {
  const sun = useId()
  const cloud = useId()
  ...
  return (
    <IconWrapper title={title} size={size} {...rest}>
      ...
      <symbol id={s24d}>
        ...
        <use xlinkHref={`#${s30}`} x="0" y="0" width="100" height="100"></use>
      </symbol>
      <use xlinkHref={`#${s24d}`} x="0" y="0" width="100" height="100"></use>
    </IconWrapper>
  )
}

export default LightRainShowersAndThunderDay
