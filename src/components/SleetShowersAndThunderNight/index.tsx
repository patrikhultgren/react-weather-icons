...
const SleetShowersAndThunderNight = ({ title, size, ...rest }: IconProps) => {
  const cloud = useId()
  ...
  return (
    <IconWrapper title={title} size={size} {...rest}>
      ...
      <symbol id={s20n}>
        ...
        <use xlinkHref={`#${s23}`} x="0" y="0" width="100" height="100"></use>
      </symbol>
      <use xlinkHref={`#${s20n}`} x="0" y="0" width="100" height="100"></use>
    </IconWrapper>
  )
}

export default SleetShowersAndThunderNight
